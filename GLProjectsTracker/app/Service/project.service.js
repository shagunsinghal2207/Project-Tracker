...
var ProjectService = (function () {
    ...
    ProjectService.prototype.CreateProject = function (url, model) {
        var body = JSON.stringify(model);
        return this._http.post(url, body, this.options)
            .map(function (response) { return response.json(); })
            .catch(this.handleError);
    };
    ProjectService.prototype.UpdateProject = function (url, id, model) {
        var body = JSON.stringify(model);
        return this._http.put(url + id, body, this.options)
            .map(function (response) { return response.json(); })
            .catch(this.handleError);
    };
    ProjectService.prototype.deleteProject = function (url, id, model) {
